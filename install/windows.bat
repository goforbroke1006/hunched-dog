...
CALL curl -L https://github.com/goforbroke1006/hunched-dog/releases/download/v0.1.5/hunched-dog__windows_amd64.exe --output "%ProgramFiles%\hunched-dog\hunched-dog.exe"
