...
GOOS=windows GOARCH=amd64 go build -o ./build/release/hunched-dog__windows_amd64.exe ./
GOOS=windows GOARCH=386   go build -o ./build/release/hunched-dog__windows_386.exe   ./
